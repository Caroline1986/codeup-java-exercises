public class DoorTest {
    public static void main(String[] args) {//<--how do we get into a java program? answer: private/public static void main.
        ...
        SlidingDoor backGlassSlidingDoor = new SlidingDoor("back sliding door");
